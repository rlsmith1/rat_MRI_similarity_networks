...
analysis_objects_dir <- paste0(base_dir, "outputs/objects/Fig3/") # to save analysis objects for figures
...
f_lme_model(
  dataframe = df_mind_cortex_system,
  independentVar = "age",
  dependentVar = "weight",
  covariates = "tbv",
...
save(
  df_edge_slopes_system,
  file = paste0(analysis_objects_dir, "27Sept2024_edge_slopes_SYS.RDS")
)
