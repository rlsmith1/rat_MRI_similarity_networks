...
## Calculate the median PND 63 network in GSK control male animals for comparison with normative cohort ##
...
save(
  ...
  file = paste0(analysis_objects_dir, "07June2024_GSK_MIND_comparison.RData")
)
