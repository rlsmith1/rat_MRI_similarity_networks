...
#SBATCH --mem=100g
#SBATCH --array=0-324
#SBATCH -e /rds/project/rds-QhAmE41a88w/scripts/logs/run-03/%a_qc1.err
#SBATCH -o /rds/project/rds-QhAmE41a88w/scripts/logs/run-03/%a_qc1.out
#SBATCH -t 12:00:00
...
## Run below if want to register only MTw scans
