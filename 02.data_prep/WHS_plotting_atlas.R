...
## Generate atlas for ggplot from WHS atlas nifti images (right and left generated separately using AFNI 3dcalc)
...
save(df_whs_atlas, file = paste0(base_dir, "objects/16Dec2024_WHS_atlas_for_plotting.RDS"))
