...
load(paste0(objects_dir, "08July2024_null_nets_withOB.RDS")) # df_null_nets_withOB (generated in data_analysis/01.validate_MIND/withOB/generate_null_nets.R)
...
save(
  ...
  file = paste0(objects_dir, "08July2024_gene_expression_withOB.RData")
)
